(function () {
    ...
    function setMoodTheme(value) {
        ...
        localStorage.setItem("moodCinemaTheme", nextTheme);
    }
    ...
    if (moodInputs.length === 0 && moodThemeRoot) {
        const savedTheme = localStorage.getItem("moodCinemaTheme");

        if (savedTheme && moodThemeClasses.includes(savedTheme)) {
            moodThemeRoot.classList.remove(...moodThemeClasses);
            moodThemeRoot.classList.add(savedTheme);
        }
    }
})();